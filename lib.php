...
function cleantheme_process_css($css, $theme) {
    ...
    $css = cleantheme_set_customcss($css, $customcss);

    return $css;
}

function cleantheme_set_logo($css, $logo) {
    global $OUTPUT;
    $tag = '[[setting:logo]]';
    $replacement = $logo;
...
function cleantheme_set_customcss($css, $customcss) {
