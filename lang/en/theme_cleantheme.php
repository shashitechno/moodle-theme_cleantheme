...
$string['solrpingerror']    =  'Apache Solr: Your site was unable to contact the
                                Apache Solr server. Search results will apper from core moodle search.';
$string['admintoolerror']   =  'Admin tool is not installed ! Search results will come from core moodle search';
$string['dependencyerror']  = 'Neither admin tool is installed nor solr is configured. Please resolve those error. Search results will apper from core moodle search';
